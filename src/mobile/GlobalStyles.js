...
/* Colors */
export const Color = {
  surface: isDarkMode ? "#101010" : "#F5F2EC",
  surfaceSurfaceContainer: isDarkMode ? "#0D0D0D" : "#efe8dc",
  colorBlack: "#000",
  surfaceSurfaceContainerLow: "#F2ECE4",
  surfaceSurfaceContainerLowest: "#FFFFFF",
  surfaceSurfaceContainerHigh: isDarkMode ? "#0F0F0F" : "#f0e8d9",
  surfaceSurfaceContainerHighest: isDarkMode ? "1C1B19" : "#e7ddcc",
  colorDimgray_100: "#5b5b5b",
  surfaceOnSurfaceVarient: isDarkMode ? "#827775" : "#534341",
  primaryPrimaryFixed: "#868686",
  surfaceOutline: "#857371",
  colorGray_100: "#262626",
  surfaceOnSurface: isDarkMode ? "#F5F2EC" : "#231919",
  colorGray_200: "#1c1b14",
  colorGray_300: "#101010",
  colorGray_400: "rgba(12, 12, 12, 0.8)",
  primaryPrimary: isDarkMode ? "#D00000" : "#a00000",
  ...
  primaryShadow: isDarkMode ? "#040404" : "#D9CFBE",
};
